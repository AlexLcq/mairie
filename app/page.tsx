...
import {Bell, FileText, Newspaper, TableProperties} from "lucide-react"
...
export default function Accueil() {
  ...
  const mainSections = [
    ...
    {
      title: "IOT",
      description: "Suivez les objets de votre tierqar",
      icon: <TableProperties className="h-12 w-12 text-red-600" />,
      link: "/iot",
